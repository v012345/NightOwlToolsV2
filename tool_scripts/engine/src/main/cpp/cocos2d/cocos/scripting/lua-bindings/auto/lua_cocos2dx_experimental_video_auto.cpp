...
int lua_cocos2dx_experimental_video_VideoPlayer_setZOrderOnTop(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::VideoPlayer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_video_VideoPlayer_setZOrderOnTop'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccexp.VideoPlayer:setZOrderOnTop");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_video_VideoPlayer_setZOrderOnTop'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.VideoPlayer:setZOrderOnTop",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_video_VideoPlayer_setZOrderOnTop'.",&tolua_err);
#endif
...
int lua_cocos2dx_experimental_video_VideoPlayer_setVolume(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::VideoPlayer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_video_VideoPlayer_setVolume'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "ccexp.VideoPlayer:setVolume");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_video_VideoPlayer_setVolume'", nullptr);
            return 0;
        }
        cobj->setVolume(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.VideoPlayer:setVolume",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_video_VideoPlayer_setVolume'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_video_VideoPlayer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"VideoPlayer");
        ...
        tolua_function(tolua_S,"setZOrderOnTop",lua_cocos2dx_experimental_video_VideoPlayer_setZOrderOnTop);
        ...
        tolua_function(tolua_S,"setVolume",lua_cocos2dx_experimental_video_VideoPlayer_setVolume);
