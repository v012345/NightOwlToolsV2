...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(3143889937u);
			...
			// EntityAgent
			meta = BEHAVIAC_NEW AgentMeta(3025655024u);
			AgentMeta::GetAgentMetas()[233220660u] = meta;
			meta->RegisterMemberProperty(136007343u, BEHAVIAC_NEW CMemberProperty< EntityStatus >("eStatus", Set_EntityAgent_eStatus, Get_EntityAgent_eStatus));
			meta->RegisterMethod(1345068219u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckAttack));
			meta->RegisterMethod(3255790239u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckAttackEnd));
			meta->RegisterMethod(3577707016u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckChase));
			meta->RegisterMethod(415597514u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckHit));
			meta->RegisterMethod(3672965080u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckHitEnd));
			meta->RegisterMethod(3197933026u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckMoveEnd));
			meta->RegisterMethod(1429071018u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_CheckTarget));
			meta->RegisterMethod(2738002727u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecuteAlert));
			meta->RegisterMethod(409236845u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecuteAttack));
			meta->RegisterMethod(3322102428u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecuteChase));
			meta->RegisterMethod(4012048601u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecuteFirstAttack));
			meta->RegisterMethod(2384586477u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecutePatrol));
			meta->RegisterMethod(1975840953u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_EntityAgent_ExecuteRandAttack));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_EntityAgent_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<EntityAgent>("EntityAgent");
			AgentMeta::Register<EntityStatus>("EntityStatus");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<EntityAgent>("EntityAgent");
			AgentMeta::UnRegister<EntityStatus>("EntityStatus");
