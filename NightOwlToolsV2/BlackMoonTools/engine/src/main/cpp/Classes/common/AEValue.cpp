...
AEValue::AEValue(const bool& value)
: m_eType(eBoolValue)
, m_iLen(sizeof(bool))
{
...
AEValue::AEValue(const int8& value)
: m_eType(eInt8Value)
, m_iLen(sizeof(int8))
{
...
AEValue::AEValue(const byte& value)
: m_eType(eByteValue)
, m_iLen(sizeof(byte))
{
...
AEValue::AEValue(const int16& value)
: m_eType(eInt16Value)
, m_iLen(sizeof(int16))
{
...
AEValue::AEValue(const uint16& value)
...
AEValue::AEValue(const int32& value)
: m_eType(eInt32Value)
, m_iLen(sizeof(int32))
{
...
AEValue::AEValue(const uint32& value)
...
AEValue::AEValue(const int64& value)
: m_eType(eInt64Value)
, m_iLen(sizeof(int64))
{
...
AEValue::AEValue(const uint64& value)
...
AEValue::AEValue(const float32& value)
...
AEValue::AEValue(const float64& value)
...
AEValue::AEValue(const std::string& str)
...
AEValue::AEValue(const char* str)
: m_eType(eStringValue)
, m_iLen(0)
{
	m_iLen = strlen(str);
...
AEValue::AEValue(const void* ptr, size_t len)
...
AEValue::AEValue(const AEValue& other)
...
AEValue& AEValue::operator=(const AEValue& other)
{
...
bool AEValue::operator<(const AEValue &other) const
{
