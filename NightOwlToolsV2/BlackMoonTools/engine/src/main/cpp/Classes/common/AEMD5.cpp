...
/// context.
void AEMD5::update(const byte* input, uint32 inputLen)
{
...
void AEMD5::final(byte(&digest)[16])
{
	byte bits[8];
	uint32 index, padLen;
...
void AEMD5::transform(const byte* block)
{
...
/// a multiple of 4.
void AEMD5::encode(byte* output, const uint32* input, uint32 inputLen)
{
...
/// a multiple of 4.
void AEMD5::decode(uint32* output, const byte* input, uint32 inputLen)
{
