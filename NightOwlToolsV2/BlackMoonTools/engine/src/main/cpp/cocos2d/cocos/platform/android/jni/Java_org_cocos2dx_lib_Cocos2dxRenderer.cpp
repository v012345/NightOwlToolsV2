...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeSetSafeAreaSize(JNIEnv*  env, jobject thiz, jint w, jint h)
    {
        cocos2d::Director::getInstance()->setSafeAreaSize(w, h);
    }
    
    JNIEXPORT void JNICALL Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeSetSafeAreaRect(JNIEnv*  env, jobject thiz, jfloat left, jfloat top, jfloat right, jfloat bottom)
    {
        cocos2d::Director::getInstance()->setSafeAreaRect(left, top, right, bottom);
    }
